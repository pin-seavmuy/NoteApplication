<template>
  <div class="p-6">
    <div class="flex items-center justify-between mb-4 space-x-72">
      <h1 class="text-2xl font-bold " style="color: #34699A;">My Notes</h1>
    ...
    <div class="flex items-center justify-between mb-4">
      ...
      <router-link to="/" class="text-2xl font-bold flex-shrink-0 hover:underline" style="color: #34699A;">WE NOTES</router-link>
      <router-link
        to="/create"
